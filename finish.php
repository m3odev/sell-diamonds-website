...
?>
	<div id="contain" style="margin-top: 2%;">
		...
		<div class="btn_ctn">
  			<a href="product.php"><input type="button" name="btn_buyitm" value="TIẾP TỤC MUA HÀNG" class="btn_buyitm"></a>
  			<a href="manage_order.php"><input type="button" name="btn_prcitm" value="ĐƠN HÀNG CỦA TÔI" class="btn_prcitm"></a>
  		</div>
	</div>
</div>
