            ...
            <div class="row" style="width: 100%;">
                <div class="col-lg-8 col-xl-8">
                    ...
                    <div class="row" style="width: 100%;margin: 0;padding: 2%;background-color: #eeeeee;">
                        <div class="col-lg-12" style="margin-bottom: 4%;">
                            <h3 class="text-center">Bạn có gì muốn nhắn nhủ Tierra?<br /></h3>
                            <div class="text-center"><i class="fa fa-envelope"></i><span style="margin-left: 1%;">tuhoang0237@gmail.com</span><i class="fa fa-phone" style="margin-left: 2%;"></i><span style="margin-left: 1%;">0123456789</span></div>
                        </div>
                ...
                <div class="col-md-12 col-lg-4 col-xl-4 hov" style="padding: 0;padding-right: 1%;">
                    ...
                    <div style="margin-bottom: 2%;">
                        ...
                        <label>Địa chỉ: </label> 219 Trung Kinh, Cầu Giấy
                    </div>
                    <div style="margin-bottom: 2%;">
                    ...
                    <div style="margin-bottom: 2%;">
                        ...
                        <label>Email: </label> tuhoang0237@gmail.com
                    </div>
                </div>
            </div>
        </div>
