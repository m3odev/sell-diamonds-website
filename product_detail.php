					...
					<div class="list_banner_detail" style="margin-bottom: 5%;">
						<div class="ctn_product_ttl">
						    ...
						    <span style="float: right;margin-right: 5%;" >
						    	<img src="./admin/img/icon_vmega.png">
						    </span>
					    </div>
					    <?php
					    ...
					    ?>
							<div class="item_1_detail" style="margin-bottom: 0;">
								<div class="imge_dtl">
									<a href="product_detail.php?san-pham=<?php echo $masp1;?>">
										<img src=<?php echo $linkhinh1;?>>
									</a>
								</div>
								<div class="name_dtl" style="margin-top: 3%;">
									<a href="product_detail.php?san-pham=<?php echo $masp1;?>"><?php echo ucwords($tensp1);?></a>
								</div>
								<?php
									if(isset($km)){
								?>
			...
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 product-image clearfix pic">
						<a href="product_detail.php?san-pham=<?php echo $masp;?>"><img src=<?php echo $linkhinh;?>></a>
					</div>
