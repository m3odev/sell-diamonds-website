				...
				<div class="col-sm-10">
					<div style="background-color:white;margin-right: -29px;margin-left: -15px;color: black;padding: 40px;">
						...
						<div class="input-group" style="width: 30%;float: right;">
					      <input type="text" class="form-control" placeholder="Search" name="search" id="search_user">
											...
											<tr>
										      	...
										      	<td  style="text-align: center;">
										      		<a href="edit_sanpham.php?id=<?php echo $masp;?>">
														<!-- <img src="./admin/img/icon_edit.png" class="img_tb2"> -->
														edit
													</a>
										      	</td>
										      	<td style="text-align: center;">
										      		<a onclick="messDelete(<?php echo $masp;?>);">
										      			<!-- <img src="./admin/img/icon_delete.png" class="img_tb2"> -->
														delete
										      		</a>
										      	</td>
									     	</tr>
